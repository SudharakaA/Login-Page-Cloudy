    ...
    <div className="login-root">
      ...
      >
        ...
        <div style={{ marginTop: "1.5rem", textAlign: "center", width: "100%" }}>
          ...
          >
            <Icon icon="mdi:information-outline" style={{ verticalAlign: "middle" }} /> Why choose Cloudyfa?
          </button>
        </div>
        {showWhy && (
          <div className="why-popup-overlay" onClick={() => setShowWhy(false)}>
            <div className="why-popup" onClick={e => e.stopPropagation()}>
              <button className="why-close" onClick={() => setShowWhy(false)} aria-label="Close">&times;</button>
              <h3>Why choose Cloudyfa?</h3>
              <ul>
                <li><b>5GB Free Storage</b> – Start for free, upgrade anytime.</li>
                <li><b>End-to-end Encryption</b> – Your privacy is our promise.</li>
                <li><b>Access Anywhere</b> – Desktop, mobile, tablet support.</li>
                <li><b>Lightning Fast</b> – Upload and share in seconds.</li>
              </ul>
            </div>
          </div>
        )}
